<template>
    <div>
        ...
        <div class="row mb-1">
            ...
            <div class="col-9">
                <div class="input-group">
                    <select class="form-control form-control-sm" v-html="settings.background_size" v-on:change="generateCss">
                        <option value=""></option>
        ...
        <div class="row mb-1">
            ...
            <div class="col-9">
                <div class="input-group">
                    <select class="form-control form-control-sm" v-html="settings.background_position" v-on:change="generateCss">
        ...
        <div class="row mb-1">
            ...
            <div class="col-9">
                <div class="input-group">
                    <select class="form-control form-control-sm" v-html="settings.background_repeat" v-on:change="generateCss">
                        <option value=""></option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-9">
                <div class="input-group">
                    <select class="form-control form-control-sm" v-html="settings.background_attachment" v-on:change="generateCss">
