<template>
    <nav class="navbar navbar-nav">
        <transition-group name="menu" enter-active-class="animated flipInX" tag="ul">
            <li v-for="route in menu" v-if="checkPermission(route.route_name)" v-bind:key="route.route_name">
                ...
                <ul v-if="route.submenu">
                    <li v-for="subroute in route.submenu" v-if="checkPermission(subroute.route_name)">
